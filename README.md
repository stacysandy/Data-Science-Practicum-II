...
## <center>Summary of Colorado K-12 Financial transparency <br> Data Science Practicum II Project</center>

### <u>Original Goal: How are financial expenditures are being spent across K through 12 schools in Colorado?</u>
<br>
...
<br>
<br>
<b>What Objective's did I meet?</b>
<br>
...
<br>
<br>
<b>In looking back at the Research Questions, did I come to some answers?</b>
<br>
...
<br>
<br>
<b>Did I meet the expectations of the "now" revealed question in this project?</b>
<br>
...
•	I continue to learn and will always learn that exploratory data analysis takes a great amount of time to synthesize.<br>
•	Categorical data can be a big pain and heart wrenching circumstance. ( I think I cried about 3 times.)<br>
•	I learned to understand complex data, you have to immerse yourself into studying every detail of the financial codes. This is not easy and is very complex. You have to become a subject matter expert in financial material you will question and may never really understand..<br>
•	I also learned to really embrace the wisdom of K.I.S.S; keep it simple stupid!<br>
•	In final, I learned you may not get the answers you had hoped for and you may find yourself with more questions than what you began with. Thus, learning and future research is necessary.<br>
•	Last but not least, I learned financing, accounting, and codes related to expenses may not my forte. It is what it is.<br>
...
Babel Number Formatting – source: http://babel.pocoo.org/en/latest/numbers.html

Blane, A. (2017, December 4). DataFrame to image. Retrieved from https://github.com/andrewblane/DataFrame_to_image/blob/master/DataFrame_to_image.ipynb

Colorado BOCES Association. (n.d). BOCES (Board of Cooperative Educational Services). Retrieved from https://www.coloradoboces.org/
...
Colorado Department of Education. (2019, October 30). Chart of Accounts: 2019-20. Copyright © 1999-2020 Colorado Department of Education. Retrieved from http://www.cde.state.co.us/cdefinance/sfCOA.htm

Colorado Department of Education. (2019, June 13). Chart of Accounts: Archive. Copyright © 1999-2020 Colorado Department of Education. Retrieved from http://www.cde.state.co.us/cdefinance/sfcoa_archive

Colorado Department of Education. (2015, March 18). Data Pipeline Organization Codes – District/BOCES Codes. Retrieved from https://www.cde.state.co.us/datapipeline/org_dist-boces

Colorado Department of Education. (2019, August 21). Periodic Collections – December Finance . Retrieved from http://www.cde.state.co.us/datapipeline/per_december-finance

Colorado Department of Education. (2019, October 22). School View: School and District Data. Copyright © 1999-2020 Colorado Department of Education. Retrieved from http://www.cde.state.co.us/schoolview

Colorado K12 Financial Transparency. (Fiscal Year 2017 – 2018). Financial Transparency for Colorado Schools. Retrieved from https://coloradok12financialtransparency.com/#/

Data.Gov. (n.d.). Colorado Department of Education School View. Retrieved from https://data.colorado.gov/K-12/Colorado-Department-of-Education-s-School-View/tedy-p7a5

Data.Gov. (n.d.). Colorado Information marketplace. Retrieved from https://data.colorado.gov/browse?category=Education

DataFlair Team. (2019, July 10). Train and Test Set in Python Machine Learning – How to Split. Retrieved from https://data-flair.training/blogs/train-test-set-in-python-ml/

Featureranking.com (n.d.). Data Preparation for Machine Learning. Retrieved from https://www.featureranking.com/tutorials/machine-learning-tutorials/data-preparation-for-machine-learning/#2.2.2

Format numbers as currency in python – source: https://stackoverflow.com/questions/37579712/format-numbers-as-currency-in-python

Lane, A. (2017, December 4). Convert Pandas DataFrames to images using IMGKit. Retrieved from https://medium.com/@andy.lane/convert-pandas-dataframes-to-images-using-imgkit-5da7e5108d55

locale Internationalization services – source: https://docs.python.org/2/library/locale.html

Menon, U. (2019, January 18). What is one-hot encoding and when is it used in data science? Retrieved from https://www.quora.com/What-is-one-hot-encoding-and-when-is-it-used-in-data-science

Ng. P. (2010, April 23). K-nearest Neighbors (KNN) Classification Model. © 2020 Ritchie Ng. Retrieved from https://www.ritchieng.com/machine-learning-k-nearest-neighbors-knn/

Pathalk, M. (2020, January 6). Handling Categorical Data in Python. Retrieved from https://www.datacamp.com/community/tutorials/categorical-data

Sanjay.M. (2018, October 26). Machine Learning –– KNN using scikit-learn. Retrieved from https://towardsdatascience.com/knn-using-scikit-learn-c6bed765be75

Sarkar, D. (2018, January 6). Categorical Data: Strategies for working with discrete, categorical data. Retrieved from https://towardsdatascience.com/understanding-feature-engineering-part-2-categorical-data-f54324193e63

Scikit-learn: Machine Learning in Python, Pedregosa et al., JMLR 12, pp. 2825-2830, 2011. Sklearn.cluster.DBSCAN. Retrieved from https://scikit-learn.org/stable/modules/generated/sklearn.cluster.DBSCAN.html

Scikit-learn: Machine Learning in Python, Pedregosa et al., JMLR 12, pp. 2825-2830, 2011. Demo of DBSCAN clustering algorithm. Retrieved from https://scikit-learn.org/stable/auto_examples/cluster/plot_dbscan.html

Shaikh, R. (2018, November 8). Choosing the right Encoding method – Label vs OneHot Endoer. Retrieved from https://towardsdatascience.com/choosing-the-right-encoding-method-label-vs-onehot-encoder-a4434493149b

Sharma, M. (2018, November 2). Data Visualization using Seaborn. Retrieved from https://towardsdatascience.com/data-visualization-using-seaborn-fc24db95a850

Tiwari, A. (2019, October 19). Data Cleaning with Python — Categorical Variables. Retrieved from https://medium.com/analytics-vidhya/data-cleaning-with-python-categorical-variables-1a904761fa27

Waskom, M. (n.d.). Plotting with categorical data. © Copyright 2012-2020. Retrieved from https://seaborn.pydata.org/tutorial/categorical.html
